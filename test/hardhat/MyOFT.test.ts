...
describe('MyOFT Test', function () {
    ...
    before(async function () {
        ...
        const EndpointV2MockArtifact = await ethers.getContractFactory('EndpointV2Mock')
        EndpointV2Mock = new ContractFactory(
            EndpointV2MockArtifact.abi,
            EndpointV2MockArtifact.bytecode,
            endpointOwner as any
        )
    })
    ...
    beforeEach(async function () {
        ...
        await myOFTA.connect(ownerA as any).setPeer(eidB, ethers.utils.zeroPad(myOFTB.address, 32))
        await myOFTB.connect(ownerB as any).setPeer(eidA, ethers.utils.zeroPad(myOFTA.address, 32))
    })
