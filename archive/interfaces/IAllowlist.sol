...
interface IAllowlist {
     ...
     */
    event AccountStatusSetByAdmin(address indexed account, uint256 indexed termIndex, bool status);
     ...
     */
    event AccountAddedFromSignature(address indexed account, uint256 indexed termIndex, uint8 v, bytes32 r, bytes32 s);
